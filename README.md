...
Both of them accept a query string, with a field name "cmd" and its value is a xml string with the command (which it is url encoded).


XML command can have the following elements :
```  
<name>_API_method_</name>
